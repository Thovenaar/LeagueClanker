...
internal static partial class AugmentTagger
{
    ...
    [
        ...
        (AugmentEffect.SummonerSpell, new(@"replaces? (a|one of your) summoner spell|replaces Flee with|summoner spell haste", RegexOptions.Compiled | RegexOptions.IgnoreCase)),
    ...
    private static readonly Dictionary<string, (AugmentEffect Add, AugmentTrigger AddTriggers, AugmentEffect Remove)> Overrides =
        new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["And My Axe!"] = (AugmentEffect.Damage | AugmentEffect.CrowdControl | AugmentEffect.ResistShred, AugmentTrigger.None, AugmentEffect.None),
            ["Apex Inventor"] = (AugmentEffect.AbilityHaste, AugmentTrigger.None, AugmentEffect.None),
            ["Archmage"] = (AugmentEffect.AbilityHaste, AugmentTrigger.AbilityHits, AugmentEffect.None),
            ["Blade Waltz"] = (AugmentEffect.SummonerSpell | AugmentEffect.Dash, AugmentTrigger.None, AugmentEffect.None),
            ["Bodyguard"] = (AugmentEffect.Shield, AugmentTrigger.Dashes, AugmentEffect.None),
            ["Chauffeur"] = (AugmentEffect.AbilityHaste | AugmentEffect.AttackSpeed, AugmentTrigger.AllySupport, AugmentEffect.None),
            ["Combusting Interest"] = (AugmentEffect.Gold, AugmentTrigger.None, AugmentEffect.None),
            ["Deathtouch"] = (AugmentEffect.OnHit | AugmentEffect.Damage, AugmentTrigger.Attacks, AugmentEffect.None),
            ["Don't Change the Channel"] = (AugmentEffect.Shield, AugmentTrigger.None, AugmentEffect.None),
            ["Flashy"] = (AugmentEffect.SummonerSpell | AugmentEffect.Dash, AugmentTrigger.None, AugmentEffect.None),
            ["Forged By The Master"] = (AugmentEffect.Damage, AugmentTrigger.None, AugmentEffect.None),
            ["Juice Box"] = (AugmentEffect.AdaptiveForce | AugmentEffect.Health, AugmentTrigger.None, AugmentEffect.None),
            ["Light 'em Up!"] = (AugmentEffect.OnHit | AugmentEffect.Damage, AugmentTrigger.Attacks, AugmentEffect.None),
            ["Mystic Punch"] = (AugmentEffect.AbilityHaste, AugmentTrigger.Attacks, AugmentEffect.None),
            ["Overloaded"] = (AugmentEffect.AbilityHaste, AugmentTrigger.None, AugmentEffect.None),
            ["Perseverance"] = (AugmentEffect.Heal, AugmentTrigger.LowHealth, AugmentEffect.None),
            ["Pursuit of Haste"] = (AugmentEffect.AbilityHaste, AugmentTrigger.AbilityHits, AugmentEffect.None),
            ["Pursuit of Power"] = (AugmentEffect.Damage, AugmentTrigger.AbilityHits, AugmentEffect.None),
            ["Quest: Icathia's Fall"] = (AugmentEffect.Health | AugmentEffect.Burn, AugmentTrigger.None, AugmentEffect.None),
            ["Quest: Rite of the Forge God"] = (AugmentEffect.AdaptiveForce | AugmentEffect.Health, AugmentTrigger.None, AugmentEffect.None),
            ["Quest: Urf's Champion"] = (AugmentEffect.AdaptiveForce | AugmentEffect.Health, AugmentTrigger.Takedowns, AugmentEffect.None),
            ["Quest: Wooglet's Witchcap"] = (AugmentEffect.AbilityPower, AugmentTrigger.None, AugmentEffect.None),
            ["Reload"] = (AugmentEffect.AbilityHaste, AugmentTrigger.Attacks, AugmentEffect.None),
            ["Restless Restoration"] = (AugmentEffect.Heal, AugmentTrigger.None, AugmentEffect.None),
            ["Righteous Fury"] = (AugmentEffect.Damage, AugmentTrigger.Healing | AugmentTrigger.Shields, AugmentEffect.None),
            ["Searing Dawn"] = (AugmentEffect.Damage | AugmentEffect.MaxHealthDamage, AugmentTrigger.AbilityHits, AugmentEffect.None),
            // Makes the target deal less damage: a defensive effect you get by attacking.
            ["Shrink Ray"] = (AugmentEffect.Armor | AugmentEffect.MagicResist, AugmentTrigger.Attacks, AugmentEffect.None),
            ["Skilled Sniper"] = (AugmentEffect.AbilityHaste, AugmentTrigger.AbilityHits | AugmentTrigger.Distance, AugmentEffect.None),
            ["Slap Around"] = (AugmentEffect.AdaptiveForce, AugmentTrigger.Immobilize, AugmentEffect.None),
            ["Slow and Steady"] = (AugmentEffect.AttackDamage, AugmentTrigger.Attacks, AugmentEffect.AttackSpeed),
            ["Spirit Infusion"] = (AugmentEffect.HealShieldPower, AugmentTrigger.Ultimate, AugmentEffect.None),
            ["Stackosaurus Rex"] = (AugmentEffect.None, AugmentTrigger.Stacking, AugmentEffect.None),
            ["Stuck in Here With Me"] = (AugmentEffect.CrowdControl, AugmentTrigger.Ultimate, AugmentEffect.None),
            ["Summoner Revolution"] = (AugmentEffect.SummonerSpell, AugmentTrigger.SummonerSpells, AugmentEffect.None),
            ["Ultimate Revolution"] = (AugmentEffect.AbilityHaste, AugmentTrigger.Ultimate, AugmentEffect.None),
            ["Ultra Hydra"] = (AugmentEffect.AttackDamage | AugmentEffect.Damage, AugmentTrigger.None, AugmentEffect.None),
            ["Weighted Popoffs"] = (AugmentEffect.AbilityHaste, AugmentTrigger.AbilityHits, AugmentEffect.None),
